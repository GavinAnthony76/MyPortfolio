    ...
    render: (visible: boolean) => (
      <div className="flex items-center justify-center min-h-screen px-6 sm:px-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 max-w-5xl w-full items-center">
          ...
          >
            <p className="text-white/60 text-sm sm:text-base leading-[2.2] mb-8">
            ...
            <p className="text-white/35 text-sm leading-[2.2]">
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-y-6 gap-x-8">
              {capabilities.map((skill, i) => (
                ...
                >
                  <span className="text-white/30 text-[11px] tracking-[0.15em] uppercase block py-3 border-b border-white/5">
                    {skill}
                  </span>
                </div>
              ))}
      ...
      <div className="flex items-center justify-center min-h-screen px-6 sm:px-10">
        ...
        >
          ...
          <a
            ...
            className="text-white/50 hover:text-white transition-colors text-sm sm:text-base tracking-[0.1em] uppercase block mb-12"
