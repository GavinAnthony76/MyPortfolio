      ...
      <div className="max-w-4xl mx-auto px-6 pt-28 pb-16">
        <div className="border border-white/10 bg-white/[0.02] p-8 md:p-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-white/60">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-white mb-4">1. Agreement Overview</h2>
              <p>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2">3.1 Initial Inquiry</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2 mt-4">3.2 Proposal and Agreement</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2 mt-4">3.3 Project Execution</h3>
              <p>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2">4.1 Payment Structure</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2 mt-4">4.2 Payment Methods</h3>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2">5.1 Client Ownership</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2 mt-4">5.2 Third-Party Components</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2 mt-4">5.3 Portfolio Usage</h3>
              <p>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2">6.1 Timeline Estimates</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2 mt-4">6.2 Client Responsibilities</h3>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2">7.1 Included Revisions</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2 mt-4">7.2 Scope Changes</h3>
              <p>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2">8.1 Service Warranty</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2 mt-4">8.2 Disclaimer</h3>
              <p>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2">10.1 Termination by Client</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-white/60 mb-2 mt-4">10.2 Termination by Developer</h3>
              <p>
