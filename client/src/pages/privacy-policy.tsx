          ...
          <div className="prose prose-slate max-w-none space-y-6 text-slate-700">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Personal Information:</strong> First name, last name, email address</li>
                <li><strong>Business Information:</strong> Company name (optional), project description, timeline requirements</li>
                <li><strong>Technical Information:</strong> Project type, target audience, key features needed</li>
                <li><strong>Additional Information:</strong> Design preferences, technical requirements, and any additional project details you provide</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Generate detailed project proposals and technical briefs</li>
                <li>Communicate with you about your project requirements and timeline</li>
                <li>Provide customer support and follow-up on project status</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Session Cookies:</strong> Used for administrative login functionality (expires after 24 hours)</li>
                <li><strong>No Third-Party Tracking:</strong> We do not use Google Analytics, Facebook Pixel, or other third-party tracking services</li>
                <li><strong>No Advertising Cookies:</strong> We do not serve advertisements or use advertising cookies</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Active projects: Duration of project plus 3 years for business records</li>
                <li>Declined proposals: 1 year for reference and improvement purposes</li>
                <li>Completed projects: 7 years for business and tax record purposes</li>
              </ul>
            </section>
