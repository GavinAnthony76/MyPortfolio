...
export default function ProjectsSection() {
  ...
  if (isLoading) {
    return (
      <section id="projects" data-host="projects" className="py-16 section-darker relative">
  ...
  return (
    <>
      <section id="projects" data-host="projects" className="py-12 sm:py-16 section-darker relative">
